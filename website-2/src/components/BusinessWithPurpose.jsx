...
const PURPOSE_ITEMS = [
  {
    icon: <TreePine size={36} color="#0054B1" strokeWidth={1.5} />,
  ...
  {
    icon: <Heart size={36} color="#0054B1" strokeWidth={1.5} />,
...
const BusinessWithPurpose = () => {
  return (
    <section style={{ background: 'transparent', padding: 'clamp(20px, 4vh, 40px) 0 clamp(30px, 5vh, 60px)', position: 'relative', overflow: 'hidden' }}>
      <motion.div
      ...
      >
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p style={{ fontSize: '16px', color: '#6B7280', fontStyle: 'italic', maxWidth: '600px' }}>
            These are not marketing promises. They are commitments built into how Incorvia Corporate Advisory operates.
          </p>
        </div>
        
        <div className="p-8 lg:p-12 rounded-[24px] flex flex-col items-center text-center" style={{
