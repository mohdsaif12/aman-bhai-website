...
const WhyIncorvia = () => (
  <section style={{ background: 'transparent', padding: 'clamp(60px, 10vh, 120px) 0', display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
    ...
    <motion.div
      ...
      style={{ padding: '100px 0 0', boxSizing: 'border-box' }}
    >
      <div className="p-8 lg:p-16 rounded-[24px] flex flex-col items-center text-center" style={{
        ...
        <p style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', color: '#4B9FF3', marginBottom: '12px', marginTop: '24px' }}>
