    ...
    <div className="container-custom grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          {FEATURES.map(({ title, desc, icon }, index) => (
            <motion.div
              ...
              style={{ display: 'flex', flexDirection: 'column', gap: '14px', alignItems: 'center', textAlign: 'center' }}
            >
      ...
      >
        <div style={{ position: 'relative' }}>
          <div style={{ background: '#fff', border: '1px solid #E5EAF0', borderRadius: '24px', padding: '12px', width: '100%', maxWidth: '380px', boxShadow: '0 25px 80px rgba(0,84,177,0.08)' }}>
          ...
          <motion.div
            ...
            style={{ position: 'absolute', bottom: '-24px', right: '-24px', width: '80px', height: '80px', borderRadius: '50%', background: '#fff', border: '1px solid #E5EAF0', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 10px 40px rgba(0,84,177,0.15)' }}
          >
            <img src="/v-icon.png" alt="Incorvia" style={{ width: '36px', height: 'auto', objectFit: 'contain', mixBlendMode: 'multiply' }} />
          </motion.div>
        </div>
      </motion.div>
    </div>
